...
export const PLAN_CONFIG = {
  ...
  FLASH: { id: 'flash', name: 'FLASH', focus: 'KHUSUS RT', priceMonthly: 55000, priceOldMonthly: 85000, priceYearly: 550000, features: ['Fitur Mading Digital & Struktur Organisasi', 'Maks 300 Warga', 'PPOB & Iuran Digital Integrasi', 'Surat Digital, Buku Tamu Digital, SOS', 'Booking Fasilitas Umum', 'AI Chatbot (50x/bln)'], systemKey: 'BASIC' },
