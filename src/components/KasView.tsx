        ...
        <div className="p-8 border-b border-slate-50 dark:border-slate-800 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6 bg-slate-50/50 dark:bg-slate-800/30">
          <div>
            ...
            >
              ...
              <span className="text-brand-blue font-black tracking-tighter" style={{ fontSize: '22px', marginTop: '2px', height: '33px' }}>Buku Kas</span>
            </h3>
              ...
              {isPengurus && (
                <>
                  <button
                    ...
                    disabled={isScanning}
                    className="flex-1 lg:flex-none flex items-center justify-center gap-3 bg-white dark:bg-slate-800 text-slate-600 dark:text-slate-200 border-2 border-[#3675c8] px-6 py-3.5 rounded-2xl text-[10px] font-black uppercase tracking-[0.2em] transition-all hover:bg-slate-50 dark:hover:bg-slate-700 active:scale-95 shadow-sm group disabled:opacity-50"
                  >
