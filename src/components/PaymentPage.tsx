      ...
      <div className={`${isEmbedded ? 'px-0 py-2' : 'max-w-6xl mx-auto px-4 md:px-8 py-10'} w-full flex-grow flex flex-col`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7">
            <form onSubmit={handlePaymentSubmit} className="bg-[#0f0f10] border border-slate-900 rounded-[2.5rem] p-8 space-y-6">
              ...
              <div className="flex items-center gap-3 pb-4 border-b border-slate-900">
                ...
                <div>
                  <h3 className="text-lg font-black text-white tracking-tight">Formulir Checkout & Metode Pembayaran</h3>
                  <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest mt-0.5">Lengkapi Data Kartu Kredit/Debet</p>
                </div>
              </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                  {[
                    ...
                    <button
                      ...
                      className={`py-2 px-1 text-center text-[10px] font-black uppercase tracking-tight rounded-xl border transition-all ${
                        selectedPlanId === p.id
              ...
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  ...
                  <div className="relative">
                    ...
                    {/* Visual indicators of detected card brand as in reference image */}
              ...
              >
                {isSubmitting ? (
                  <>
                    ...
                    <span>Memproses Transaksi Secure...</span>
                  </>
                ) : (
                  <>
