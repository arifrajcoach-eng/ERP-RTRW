          ...
          <div className="mt-6 flex flex-wrap gap-4">
            <div className="relative">
              <button 
                ...
                className="p-2 md:p-2.5 text-white rounded-xl font-black flex items-center justify-center hover:opacity-95 transition-all duration-300 shadow-xl shadow-indigo-500/20 cursor-pointer active:scale-95 relative overflow-hidden group"
            ...
            <div className="relative">
              <button 
                ...
                className="p-2 md:p-2.5 text-white rounded-xl font-black flex items-center justify-center hover:opacity-95 transition-all duration-300 shadow-xl shadow-indigo-500/15 cursor-pointer active:scale-95"
            ...
            <div className="relative">
              <button 
                ...
                className="p-2 md:p-2.5 bg-[#0d1527] hover:bg-[#121c33] text-white border-2 border-emerald-500/30 hover:border-emerald-500 rounded-xl font-black transition-all duration-300 flex items-center justify-center shadow-lg shadow-emerald-500/10 active:scale-95 cursor-pointer relative group overflow-hidden"
